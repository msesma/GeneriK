package com.paradigmadigital.ui.terms
...
class ServiceConnection(connectionCallback
                        : ServiceConnection.ServiceConnectionCallback) : CustomTabsServiceConnection() {
